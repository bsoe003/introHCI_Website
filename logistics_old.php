      ...
      <div class="row">
         ...
         <div class="col-md-9" id="logistics">
            ...
            <div id="lab" class="sidenav-anchor">
               <h3>Lab</h3>
               <p>The laboratory curriculum teaches you the tools for designing and implementing effective interaction designs. It functions as an interactive session with downloadable code and walkthroughs.</p>

               <p>Lab slides will be up on the class website the day before lab. Each week, there will be a lab assignment due at the end of class. You should be able to complete the lab assignment by attending the lab session and following the instructor. However, you may choose to try complete the lab assignment on your own between Tuesday night and Thursday class time. If you run in to any issues and need help, please come to the Thursday lab session to complete your assignment. Otherwise, you may turn in the lab assignment in advance and do not have to come to lab, except when there is a quiz.</p>

               <p>If you encounter problems with submitting your lab assignment that cannot be solved by the end of class, there are TAs that hold office hours after lab to help. You are welcome to come get additional help with these problems. Lab assignments can be submitted until 2pm Thursday.</p>
            </div>

            <div id="assignments" class="sidenav-anchor">
               <h3>Assignments &amp; Deliverables</h3>
               <p>You'll have a weekly design project, submitted online by Thursday 11:59pm and shared in studio on Friday. Your project work culminates in a presentation and poster at the end of the quarter in front of invited design jurors. Your team will share its quarter-long design project.</p>
            </div>
            <div id="Submit" class="sidenav-anchor">
               <h4>Submit work online</h4>
               <p>You will use <a href="http://www.ucsd-hci.com">www.ucsd-hci.com</a> to submit your work. Your assignments will be submitted online as a pdf or word doc including plain text and a series of digital photographs or screenshot. Do not spend time "beautifying" your submission. Submit early! Late assignments will not be accepted. There are three reasons that assignments need to be submitted on time. First, to be able to provide you with rapid feedback about your work, the teaching staff meets on Friday afternoon to grade. Second, you'll present your work in studio every week, and you need to be prepared to participate. Third, after the submission deadline, students can view each others' assignments, so that you can learn from each other. We encourage you to see what your peers are up to.</p>
               <p>No late assignments will be accepted, but you may submit them early. If there is a problem with the website that makes it so you cannot submit your assignment, you must message your TA on Piazza by 1am or else it’s a 0. You can only do this once.</p>
            </div>
            <div id="Assessment" class="sidenav-anchor">
               <h3>Assessment</h3>
               <p>The rubrics in each assignment explain how you and the staff will grade your submission. The rubric cells summarize performance at different levels, from 'nope' through 'mastery'. While <i>true</i> mastery in any field is a <a href="http://www.amazon.com/Othello-Minute-Learn-Lifetime-Master/dp/B001XHNL3W">lifelong</a> process, we don't expect you to become <a href="http://www.nytimes.com/2014/08/10/magazine/garry-kasparov.html">Garry Kasparov</a> or <a href="http://www.newyorker.com/magazine/2015/02/23/shape-things-come">Jony Ive</a> in just 10 weeks. (That will take until next quarter.) For this course, 'mastery' means performing at the level described in that rubric, as interpreted by the assignment. So make sure to review the entire assignment before submitting.</p>
            </div>
            <div id="scale" class="sidenav-anchor">
               ...
               <div>
                  <div>
                     <h5>What is the 'out of the box' column in the rubric?</h5>
                  </div>
                  <div>
                  ...
                  <div id="regrades" class="sidenav-anchor">
                     <h4>Regrades</h4>
                     <p>It is very important to us that all assignments are properly graded. The teaching staff works extremely hard to grade fairly and to turn around assignments quickly. We know what you work hard, and we respect that. Occasionally, mistakes happen, and it's important to us to correct them. If you believe there is an error in your assignment or exam grading, please <b>submit an explanation in writing</b> to your studio TA within 7 days of receiving the grade. This explanation should list the score that you think is most accurate for each rubric item, and the explanation for why that score is more accurate than the one you received. A second staff member will regrade the entire assignment to ensure quality, and that grade will be your final score. Make sure that the staff have access to all materials needed (e.g., the version of your app as of the submission deadline, login information, images or physical copies of any materials shown in person but not submitted online). No regrade requests will be accepted orally, and no regrade requests will be accepted more than 7 days after receipt of the assignment. Regrade requests must be respectful; we will not consider any regrade requests containing disrespectful language. If you hassle your TA verbally about grading, that automatically earns you a 0 on the assignment.</p>
                  </div>
                  <div id="attendance" class="sidenav-anchor">
                     <h4>Attendance & Participation</h4>
                     <p>Design is a contact sport, and studio is where the action is. Sharing your work and discussing designs with others is an important part of your design education. Therefore, studio attendance is mandatory. To receive credit for attendance, you must arrive on time. You are allowed <strong>two excused</strong> absences for the quarter without penalty; thereafter you will receive zero credit for the missed studio. To receive an excused absence, you must ask your studio leader <strong>in advance</strong>, and receive an acknowledgment from the studio leader.

                        <p>If you are more than 5 minutes late (or leave early), you will be marked as absent. Because of the number of group activities that we do in studio, it's important that everyone comes on time.</p>

                        <ul>
                           <li>Excusable absences include family emergencies, job interviews, and presenting at a conference. It does not include wanting to leave early for long weekend or vacation.</li>
                           <li>Attending another class during lecture or studio is not an excusable absence.</li>
                           <li>Athletes who would like to miss more than one studio to participate in athletic competitions must make any request during the first week of class.</li>
                        </ul>
                  </div>
                  ...
                  <div id='self' class='sidenav-anchor'>
                     ...
                     <p>Part of being a designer&thinsp;&ndash;&thinsp;or practitioner in any field&thinsp;&ndash;&thinsp;is knowing how well you're doing. That metacognitive skill is one of the course goals. To help build that skill, every week in studio you'll self-assess your work. </p>
                     <p>Being able to successfully assess your own performance in comparison to a given criterion is a skill that you will draw benefit from, both as a student and in your professional career. This is not always an easy task and we hope that this exercise will help you improve your self-assessment skills and get you start thinking about how to evaluate your own work using the yardstick of the setting.</p>

                     <p>When your self-assessment is reasonable, you'll receive the average of your grade and the TAs. In this class, what that means is that if &#124;&thinsp;self-assessment&thinsp;&#45;&thinsp;staff grade&thinsp;&#124;&thinsp;&#8804;&thinsp;2, you will receive the average of the two (and also credit for self-assessing well). If they differ by more than 2 points, you'll receive the staff grade. Submitting a self-assessment is a prerequisite for receiving a grade. Even if you miss studio, you are still responsible for submitting a self-assessment.</p>
                     <h5>Team Assignments</h5>
                     <p>For team assignments, you'll self-assess as a team and then individually assess your own and teammates performance. In general, everyone on the team will earn the same grade. However, if a majority of the team reports that an individual was more/less successful in achieving their goals, that individual's grade will be adjusted accordingly.</p>

                     <h5>How well does self-assessment work?</h5>
                     <p>Occasionally, a student will say that self-assessment feels like 'guessing'. If so, students are very good guessers. With impressive consistency, well over half of all students self-assess with 1 point of the staff grade, and well over 80% are within 2 points. Also, when we all meet Friday afternoon, we grade the assignments together to insure consistent grading across studios.</p>
