...
<html>
  <head>
    ...
    <title>Intro to HCI: Extra Credit Assignments</title>
        ...
        <div class="row">
		    ...
		    11:59pm.</p>
                ...
                <div id="inspirations" class="sidenav-anchor">
                    <h2>Revisit Inspiration</h2>
                    <p>Before the implementation of your prototype, you compiled a list of inspirations. Since then, your prototype has probably made so many twists and turns and transformations that it is no longer recognizable as the idea that you started off with. To prepare for your final presentation, update your knowledge of related projects. Related projects can be existing applications, artifacts, products, or services that relate to your concept. Here, web search is your friend (potentially useful sites include Google, Google Scholar, the ACM Digital Library, TechCrunch, Engadget...). Pick the five related projects that a juror is mostly like to ask you "How are you different than _____?" In some cases, this might be a similar service like another to-do list, photo-sharing app, or party-finder. In other cases, it might be repurposing general services like Google Docs or Twitter.</p>
                    <p>Pick out your five favorite related projects. For each project, write a ~2 sentences that would answer juror questions like, "How are you different from _____? Why would people use your application instead of _____? In what situations would people use _____ instead of your application?"</p>

                    <a class='btn btn-primary' href="http://www.ucsd-hci.com">Submit</a>
                    <div class="table-responsive">
                        <table class="table">
                            <tbody>
                                <tr>
                                ...
                                <tr>
                                    <td>Revisit Inspiration<br /><span style="color:lightGray;">3 points</span></td>
                                    <td>0: No extra credit submitted or any number of related projects submitted without meaningful explanation.</td>
                                    <td>1: One or two key relevant projects found and differences explained. (If more than two submitted, the rest are not relevant or not well explained.)</td>
                                    <td>2: Three or four key relevant projects found and differences explained. (If more than three submitted, the rest are not relevant or not well explained.)</td>
                                    <td>3: Five relevant projects found and differences explained. A juror will exclaim "Wow, you've really done your homework!"</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                        ...
                        <table class="table">
                            <tbody>
                                <tr>
                                    ...
                                    <th id="unsatisfactory" valign="top">Nope</th>
                                    <th id="minimum" valign="top">Adequacy</th>
                                    <th id="proficiency" valign="top">Proficiency</th>
                                    <th id="mastery" valign="top">Mastery</th>
                                </tr>
                                <tr>
                                    <td>Publicize Your App<br /><span style="color:lightGray;">4 points</span></td>
                                    <td>0: Nothing submitted beyond the analytics that were a part of the main assignments.</td>
                                    <td>1: Evidence that you advertised on social media. BUT not evidence that people are <i>using</i> it (beyond what A9 required).</td>
                                    <td>3: Evidence that your social media advertising was widely noticed. AND evidence that a few people, or only people you know, have started using it (beyond what A9 required).</td>
                                    <td>4: Evidence that your social media advertising was widely noticed. AND evidence of its accessibility and more than a couple strangers (who are not people you know or in this class) have found your app and started using it. Submission includes longitudinal data (100+ users over 1+week over and above A9) on Woopra<wbr>/<wbr>Google Analytics.</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div id="video" class="sidenav-anchor">
                    <h2>Create a Video Demonstrating Your App</h2>
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    <td>Create a Video<br /><span style="color:lightGray;">5&thinsp;pts</span></td>
                                    <td>0: No user-centered motivation. Don't get to see a clear scenario showing several screens of the app and how it connects to the user's motivation. </td>
                                    <td>2: Video effectively conveys the user-centered motivation of the app's value. OR walks through a scenario with the app's main features. but not both.</td>
                                    <td>4: Video covers both the motivation behind the app. AND walks through a scenario  showing several screens of the app and how it connects to the user's motivation. AND is visually attractive.</td>
                                    <td>5: Video covers both the motivation behind the app. AND walks through a scenario  showing several screens of the app and how it connects to the user's motivation. AND is visually attractive. AND has mass appeal & creativity.</td>
                                </tr>

                                    <td headers="guiding" colspan=2><br>Outside the Box<br><span style="color:lightGray;"><span style="color:lightGray;">1&thinsp;pt</span></td>
                                    <td colspan=3 align=right>The best video in the class will receive 6 points for this assignment.</td>
                             </tbody>
                        </table>
                    </div>
                </div>
