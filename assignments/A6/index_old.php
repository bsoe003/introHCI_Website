                    ...
                    <div class="table-responsive">
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    <td>Competitive Analysis<br /><span
				    style="color:lightGray;">1 points</span></td>
                                    <td>0: No competive analysis is present or
				    does not describe a unique aspect.</td>
				    <td></td>
				    <td></td>
				    <td>1: Competive analysis is present and is
				    accurate.</td>
                                </tr>
                                <tr>
                                    <td>Interaction Flow<br /><span
				    style="color:lightGray;">3 points</span></td>
